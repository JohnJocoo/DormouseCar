...
# name your project
##########################################################################
project(ArduinoCoreAvr LANGUAGES C)
...
# building library
##########################################################################
set(ARDUINO_CORE "${CMAKE_SOURCE_DIR}/cores/arduino")
set(VARIANT_STD "${CMAKE_SOURCE_DIR}/variants/standard")

include_directories(${ARDUINO_CORE})
include_directories(${VARIANT_STD})

set(LIB_HEADERS
      "${ARDUINO_CORE}/Arduino.h"
      "${ARDUINO_CORE}/binary.h"
      "${VARIANT_STD}/pins_arduino.h"
...
add_custom_command(TARGET arduinocoreavr
                   POST_BUILD
